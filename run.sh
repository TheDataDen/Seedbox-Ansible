...
echo "THERE HAVE BEEN SOME MAJOR CHANGES TO THIS PROJECT RECENTLY. PLEASE READ THE 'README.md' FILE AND CHECK THE CONTENTS OF THE 'vars/main.yml' FILE BEFORE RUNNING THIS SCRIPT. PRESS ENTER TO IF YOU ARE READY TO RUN THE PLAYBOOK OTHERWISE PRESS CTRL+C TO EXIT."
read
